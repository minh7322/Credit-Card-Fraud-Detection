...
\titleformat{\section}[block]
  ...
  {CHAPTER \thesection.}{0.5em}{\MakeUppercase}
...
\begin{center}
\vspace{-40pt}
\textbf{NATIONAL ECONOMICS UNIVERSITY}\\[4pt]
\textbf{\fontsize{16pt}{18pt}\selectfont SCHOOL OF TECHNOLOGY}
\vspace{0.5cm}
 \begin{figure}[H]
     \centering
 ...
 \end{figure}
\vspace{1.5cm}
\fontsize{24pt}{28pt}\selectfont REPORT\\
\vspace{12pt}
\textbf{\fontsize{28pt}{32pt}\selectfont MACHINE LEARNING}
\vspace{1.5cm}
\end{center}
\begin{center}
\textbf{\fontsize{14pt}{16pt}\selectfont Topic:}\\[0.35cm]
    \textbf{\fontsize{18pt}{22pt}\selectfont CREDIT CARD FRAUD DETECTION USING XGBOOST AND DRIFT-AWARE CHUNK EVALUATION}
\vspace{1.5cm}
\begin{table}[H]
    \centering
    \begin{tabular}{l l}
 \fontsize{14pt}{16pt}\selectfont Student: & \fontsize{14pt}{16pt}\selectfont NGUYEN HUY MINH \\ [3pt]
 \fontsize{14pt}{16pt}\selectfont Class: & \fontsize{14pt}{16pt}\selectfont AI66A \\ [6pt]
 \fontsize{14pt}{16pt}\selectfont Supervisor: & \fontsize{14pt}{16pt}\selectfont Dr. Thien Van Luong \\ [6pt]
\end{tabular}
\end{table}
\vspace{3cm}
 \fontsize{14pt}{16pt}\selectfont Hanoi, May 2026
\end{center}
\end{titlepage}
